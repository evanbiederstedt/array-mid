...
describe('basic functionality test', function(){
    ...
    it('check n > 1, array length 6', function(){
        ...
        expect(function() { mid(six, 3)}).to.throw('Users cannot return an odd number of elements n > 1 from position="center" of an even-lengthed array. This is logically inconsistent. Please fix.'); 
